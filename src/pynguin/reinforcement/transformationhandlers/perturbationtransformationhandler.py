...
class PerturbationTransformationHandler(AbstractTransformationHandler):
    """Transformation handler for the parameter RandomPerturbation"""
    ...
    def get_value(self):
        return config.configuration.search_algorithm.random_perturbation
