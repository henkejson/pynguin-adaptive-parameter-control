...
class PopulationTransformationHandler(AbstractTransformationHandler):
    """Transformation handler for the parameter Population"""
    ...
    def get_value(self):
        return config.configuration.search_algorithm.population
