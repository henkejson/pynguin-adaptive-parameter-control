...
class TestInsertTransformationHandler(AbstractTransformationHandler):
    """Transformation handler for the parameter TestInsertProbability"""
    ...
    def get_value(self):
        return config.configuration.search_algorithm.test_insert_probability
    ...
    def apply_action(self, normalized_action):
        ...
        config.configuration.search_algorithm.test_insert_probability = current_value

    def get_name(self):
        return config.TuningParameters.TestInsertProbability.value
