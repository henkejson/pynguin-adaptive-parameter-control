...
class ChromosomeLengthTransformationHandler(AbstractTransformationHandler):
    """Transformation handler for the parameter ChromosomeLength"""
    def __init__(self, min_value: int = -1, max_value: int = 1):
        self.min_value = float(min_value)
        self.max_value = float(max_value)

        self.config_lower_bound = 20.0
        self.config_upper_bound = 80.0
    ...
    def get_value(self):
        return config.configuration.search_algorithm.chromosome_length
